...
<html>
    <head>
        ...
        <title>Xóa tài khoản - Shop YNT - Phong cách độc đáo  </title>
  ...
  <script type="text/javascript">
    ...
    <body>
        ...
        <div class="head">
        			  ...
        			  <div class="logo" title="YNT">  <a href="admincontroller.php?action=home"> <img src="images/logo.png">  </a>
                      </div>
        ...
        <div class="box">
        			...
        			<div class="content">
                         ...
                         <a href="#" title="Sửa tài khoản"> 
                            Xóa tài khoản </a> </div> </center><br/><br/>
                            
                             <?php
           
           
                $n = new customer();
                $pro = $n->getcustomerById($_GET["id"]);                
            
        ?> 
                            
                            
                             <form action="admincontroller.php?action=delete_account_process" method="POST" onsubmit="return formtk();" name="login">
                                 ...
                                 <div class="khungchua">
                                    ...
                                    <div class="khungnhapsp"> <input type="text" name="TenTK" placeholder="Nhập tài khoản" style="width:170px;"
                                                                     readonly="readonly"
                                                                     value="<?php echo $pro[1]; ?>"
                                                                     title="Nhập tên tài khoản"> </div>
                            </div>	
                            ...
                            <?php endif; ?>
							   <div class="khungchua">
                                    ...
                                    <div class="khungnhapsp"> <input type="text" name="MkTK" placeholder="Nhập mật khẩu" style="width:170px;"
                                                                      readonly="readonly"
                                                                     value="<?php echo $pro[2]; ?>"
                                                                     title="<?php echo $pro[2]; ?>"> </div>
                            </div>	
                             ...
                             <div class="khungchua">
                                    ...
                                    <div class="khungnhapsp"> <input type="text" name="TenKH" placeholder="Nhập tên khách hàng"  style="width:170px;"
                                                                      readonly="readonly"
                                                                     value="<?php echo $pro[3]; ?>"
                                                                     title="<?php echo $pro[3]; ?>"> </div>
                            </div>	
                           ...
                           <div class="khungchua">
                                    ...
                                    <div class="khungnhapsp"> <input type="text" name="Sdt" placeholder="Nhập số điện thoại" style="width:170px;"
                                                                      readonly="readonly"
                                                                     value="<?php echo $pro[4]; ?>"
                                                                     title="<?php echo $pro[4]; ?>"> </div>
                            </div>	
                           
                                 <div class="khungchua">
                            		<div class="khungsp"> Email: </div>
                                    
                                    <div class="khungnhapsp"> <input type="text" name="Email" placeholder="Nhập email "  style="width:170px;"
                                                                      readonly="readonly"
                                                                     
                                                                     value="<?php echo $pro[5]; ?>"
                                                                     title="<?php echo $pro[5]; ?>"> </div>
                            </div>	
                               ...
                               <div class="khungchua">
                                    ...
                                    <div class="khungnhapsp"> <input type="text" name="DiaChi" placeholder="Nhập địa chỉ"  style="width:170px;"
                                                                      readonly="readonly"
                                                                     value="<?php echo $pro[6]; ?>"
                                                                     title="<?php echo $pro[6]; ?>"> </div>
                            </div>	
                               ...
                               <div class="khungchua">
                                    ...
                                    <a href="admincontroller.php?action=account"> <input type="button" name="quayve"  value="Quay về" title="Quay về trang tài khoản" id="input_reset" style="margin-right:-17px;width:80px"></a></div>
                            </div>	
