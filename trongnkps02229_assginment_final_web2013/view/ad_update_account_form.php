...
<html>
    <head>
        ...
        <title>Sửa tài khoản - Shop YNT - Phong cách độc đáo  </title>
  ...
  <script type="text/javascript">
    ...
    <body>
        ...
        <div class="box">
        			...
        			<div class="content">
                         ...
                         <a href="#" title="Sửa tài khoản"> 
                            Sửa tài khoản </a> </div> </center><br/><br/>
        ...
        ?> 
                             ...
                             <form action="admincontroller.php?action=update_account_process" method="POST" onsubmit="return formtk();" name="login">
