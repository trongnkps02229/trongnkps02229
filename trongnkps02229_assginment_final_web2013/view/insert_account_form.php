...
<html>
    <head>
        ...
        <title>Tạo tài khoản - Shop YNT - Phong cách độc đáo  </title>
...
<!--Ket thuc hieu ung-->
  ...
  <script type="text/javascript">
    ...
    <body>
        ...
        <div class="box">
        			...
        			<div class="content">
                         ...
                         <a href="#" title="Tạo tài khoản"> 
                            Tạo tài khoản </a> </div> </center><br/><br/>
                            
                            
                            <form action="usercontroller.php?action=insert_account_process" method="POST" onsubmit="return formtk2();" name="login">
							   ...
							   <div class="khungchua">
                                    ...
                                    <div class="khungnhapsp"> <input type="password" name="MkTK" 
                                                                      style="width:170px;"
      ...
      <div class="foter">
     <a href="usercontroller.php?action=home"> <br/> Cửa hàng quần áo YNT<br/>trongnkps02229<br>
     				</a>
      </div>
